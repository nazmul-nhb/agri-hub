    ...
    <div className="max-w-lg mx-auto bg-white shadow p-6 rounded">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <input
          ...
          className="w-full p-2 border border-primary outline-0 focus:border-2 transition-all duration-300 rounded"
        />
        {errors.attachment && <p className="text-red-500">Invalid file format. Only images or documents are allowed.</p>}
      ...
      <div className="mt-8 p-4 bg-gray-100 rounded-lg">
        <h3 className="text-xl font-semibold">Agricultural Extension Services Contact</h3>
        <p className="text-gray-700">For immediate support, you can reach out to the Agricultural Extension Services:</p>
        <p className="text-gray-700">
          Phone: <a href="tel:+8801623732187" className="text-primary">+880 1623 732187</a>
        </p>
        <p className="text-gray-700">
          Email: <a href="mailto:extension@agri-hub.com" className="text-primary">extension@agri-hub.com</a>
        </p>
      </div>
    </div>
  </SectionWrapper>
